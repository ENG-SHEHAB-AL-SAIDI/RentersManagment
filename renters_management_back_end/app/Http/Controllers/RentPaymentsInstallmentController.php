...
class RentPaymentsInstallmentController extends Controller
{
    // /**
    ...
    // {
    //     $rentPaymentsInstallmentController = RentPaymentsInstallmentController::where('renter_id',$renterId)->with('rentPaymentsInstallments')->get()->groupBy('year');
