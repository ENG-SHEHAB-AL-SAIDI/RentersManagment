  ...
  return Center(
    ...
    children: [
      ...
      Row(
          ...
          if(!includeInstallment)...[ Divider(),]else...[
            Divider(),
            Text("  Installments:")
          ],
          ...
          child: Column(
            children: [
              ...
              if ((rentPayment.rentPaymentsInstallment == null) || rentPayment.rentPaymentsInstallment!.isEmpty) ...[
                ...
                for (int i =0; i<rentPayment.rentPaymentsInstallment!.length;i++) ...[
                  if(i!=0)...[
                    Divider()
                  ],
                  Padding(
                      ...
                      // mainAxisAlignment: ,
                        children: [
                          SizedBox(
                            width: (PdfPageFormat.a4.width - 128) / 6,
                            child: Text(
                              (rentPayment.rentPaymentsInstallment![i].date?.value != null)
                                  ? dateFormat
                                  .format(DateTime.parse(rentPayment.rentPaymentsInstallment![i].date!.value))
                                  .toString()
                                  : "Unknown",
                              style: TextStyle(fontSize: 8),
                            ),
                          ...
                          SizedBox(
                            ...
                            child: Text(
                              rentPayment.rentPaymentsInstallment![i].notes?.value ?? "",
                              style: TextStyle(fontSize: 8),
                            ),
                          ),
                        ]),
