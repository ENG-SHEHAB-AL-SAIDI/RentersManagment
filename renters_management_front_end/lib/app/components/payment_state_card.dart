              ...
              children: [
                      ...
                      Row(
                        ...
                        children: [
                            ...
                            children: [
                              ...
                              SecText(
                                (rentPayment?.month?.value != null)
                                    ? "${months[rentPayment?.month
                                    ?.value]} (${rentPayment?.month?.value})"
                                    : "Unknown",
                                textColor: textColor,
                              ),
                            ],
                          ...
                          PopupMenuButton<String>(
                            onSelected: (val) =>
                                controller.paymentMore(val, rentPayment!),
                            color: AppColors.inverseCardColor,
                            itemBuilder: (ctx) =>
                            [
                              PopupMenuItem(
                                value: (rentPayment?.state?.value != "excluded")
                                    ? "exclude"
                                    : "include",
                                child: SecText(
                ...
                Container(
                  ...
                  child: ExpansionTile(
                    ...
                    initiallyExpanded: !((rentPayment?.state?.value ?? "") ==
                        "excluded") && initiallyExpanded,
                    title: SecText(
                    ...
                    children: [
                            ...
                            Row(
                              ...
                              children: [
                                SizedBox(
                                    width: ((Get.width - 45) * (1 / 5)),
                                    child: SecText(
                                      (rentPayment?.rentPaymentsInstallment?[i]
                                          .date
                                          ?.value !=
                                          null)
                                ...
                                SizedBox(
                                    ...
                                    child: SecText(
                                      "${rentPayment
                                          ?.rentPaymentsInstallment?[i].amount
                                          ?.value ?? "Unknown"}",
                                      textColor: color1,
                                      fontSize: Utils.fontSizeScale(
                                          expansionTileChildrenFontSize),
                                    ...
                                    onPressed: () async {
                                      ...
                                      if (changed != "") {
                                        ...
                                        controller.updateInstallment(
                                            rentPayment?.id.value, rentPayment
                                            ?.rentPaymentsInstallment?[i].id
                                            .value, {
                                              "notes":changed
                                        });
                                      }
                      ...
                      CustomButton(
                        onPress: () => controller.addInstallment(
                            rentPayment?.id.value,
                            rentPayment?.remainAmount?.value),
